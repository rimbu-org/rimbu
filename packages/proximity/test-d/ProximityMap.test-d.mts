...
// .context
expectType<ProximityMap.Context<number>>(genEmpty.context);
expectType<ProximityMap.Context<number>>(genNonEmpty.context);
...
// .toBuilder()
expectType<ProximityMap.Builder<number, string>>(genEmpty.toBuilder());
expectType<ProximityMap.Builder<number, string>>(genNonEmpty.toBuilder());
