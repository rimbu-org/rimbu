...
import type { HashMultiMapSortedValue } from '@rimbu/multimap/hash-key/sorted-value';
...
expectTypeOf(genEmpty.keyMap).toExtend<
	HashMap<number, SortedSet.NonEmpty<string>>
>();
expectTypeOf(genNonEmpty.keyMap).toExtend<
	HashMap.NonEmpty<number, SortedSet.NonEmpty<string>>
>();
...
expectTypeOf(genEmpty.toBuilder()).toEqualTypeOf<
	HashMultiMapSortedValue.Builder<number, string>
>();
