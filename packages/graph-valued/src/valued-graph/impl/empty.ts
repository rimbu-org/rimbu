...
export class ValuedGraphEmpty<
    ...
    TpG extends CustomGraphNonValuedBase.WithGraphValues<
      Tp,
      N,
      V
    > = CustomGraphNonValuedBase.WithGraphValues<Tp, N, V>
  >
  extends CustomGraphNonValuedBase.GraphEmptyBase
  implements ValuedGraphBase<N, V, Tp>
{
  ...
  mapValues<V2>(): CustomGraphNonValuedBase.WithGraphValues<
    Tp,
    N,
    V2
  >['normal'] {
