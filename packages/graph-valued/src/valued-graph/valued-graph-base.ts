...
> extends VariantValuedGraphBase<N, V, Tp>,
    CustomGraphNonValuedBase.GraphConnect<N, V, Tp> {
  /**
   * Returns the `context` associated to this collection instance.
   */
  readonly context: CustomGraphNonValuedBase.WithGraphValues<
    Tp,
    N,
    V
  >['context'];
   ...
   */
  readonly linkMap: CustomGraphNonValuedBase.WithGraphValues<
    Tp,
    N,
    V
  >['linkMap'];
  ...
  ): CustomGraphNonValuedBase.WithGraphValues<Tp, N, V>['linkConnections'];
  /**
   ...
   */
  toBuilder: () => CustomGraphNonValuedBase.WithGraphValues<
    Tp,
    N,
    V
  >['builder'];
   ...
   */
  extendValues: <V2>() => CustomGraphNonValuedBase.WithGraphValues<
    Tp,
    N,
    SuperOf<V2, V>
  >['normal'];
...
export namespace ValuedGraphBase {
  type NonEmptyBase<N, V, Tp extends ValuedGraphBase.Types> =
    VariantValuedGraphBase.NonEmpty<N, V, Tp> &
      CustomGraphNonValuedBase.GraphConnectNonEmpty<N, V, Tp> &
  ...
  > {
     ...
     */
    connectAll: (
      connections: StreamSource<
        CustomGraphNonValuedBase.WithGraphValues<Tp, N, V>['link']
      >
    ) => boolean;
    /**
     ...
     */
    build: () => CustomGraphNonValuedBase.WithGraphValues<Tp, N, V>['normal'];
  }
  ...
  export interface Types extends VariantValuedGraphBase.Types {
    readonly normal: ValuedGraphBase<this['_N'], this['_V']> &
      CustomGraphNonValuedBase.VariantGraphBase<this['_N'], this['_V']>;
