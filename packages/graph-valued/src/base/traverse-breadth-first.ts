...
import { LinkType } from '../graph-custom';

class GraphBreadthFirstStream<
  G extends CustomGraphNonValuedBase.VariantGraphBase.NonEmpty<N, any>,
  N
...
export function traverseBreadthFirstCustom<
  G extends CustomGraphNonValuedBase.VariantGraphBase<N, any>,
  N
>(
  graph: G,
  startNode: N,
...
export function traverseBreadthFirstHashed<
  G extends CustomGraphNonValuedBase.VariantGraphBase<N, V>,
  N,
  V
