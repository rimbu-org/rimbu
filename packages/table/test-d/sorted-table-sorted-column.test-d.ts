...
import type { SortedTableSortedColumn } from '@rimbu/table/sorted-row/sorted-column';
...
type Context = SortedTableSortedColumn.Context<number, string>;
type RowType = SortedMap<string, boolean>;
type RowType_NE = SortedMap.NonEmpty<string, boolean>;
type Builder = SortedTableSortedColumn.Builder<number, string, boolean>;
...
// .rowMap
expectTypeOf(genEmpty.rowMap).toExtend<SortedMap<number, RowType_NE>>();
expectTypeOf(genNonEmpty.rowMap).toExtend<
	SortedMap.NonEmpty<number, RowType_NE>
>();
