...
import type { SortedMap } from '../src';
...
expectAssignable<RMap<number, string | boolean>>(genNonEmpty);
...
// .context
expectType<SortedMap.Context<number>>(genEmpty.context);
expectType<SortedMap.Context<number>>(genNonEmpty.context);
...
// .toBuilder()
expectType<SortedMap.Builder<number, string>>(genEmpty.toBuilder());
expectType<SortedMap.Builder<number, string>>(genNonEmpty.toBuilder());
