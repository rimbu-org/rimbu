...
import type { SortedSet } from '../src/main/index.mjs';
...
// .context
expectType<SortedSet.Context<number>>(genEmpty.context);
expectType<SortedSet.Context<number>>(genNonEmpty.context);
