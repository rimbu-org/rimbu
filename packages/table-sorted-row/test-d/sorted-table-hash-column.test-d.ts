...
import type { SortedTableHashColumn } from '../src';
...
type Context = SortedTableHashColumn.Context<number, string>;
type RowType = HashMap<string, boolean>;
type RowType_NE = HashMap.NonEmpty<string, boolean>;
type Builder = SortedTableHashColumn.Builder<number, string, boolean>;
...
// .rowMap
expectAssignable<SortedMap<number, RowType_NE>>(genEmpty.rowMap);
expectAssignable<SortedMap.NonEmpty<number, RowType_NE>>(genNonEmpty.rowMap);
