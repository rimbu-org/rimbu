...
export namespace ArrowValuedGraphHashed {
  ...
  export interface Types extends ArrowValuedGraphBase.Types {
    ...
    linkMapNonEmpty: HashMap.NonEmpty<
      this['_N'],
    ...
    linkMapBuilder: HashMap.Builder<
      this['_N'],
...
interface TypesImpl extends ArrowValuedGraphHashed.Types {
  context: ValuedGraphContext<this['_N'], 'ArrowValuedGraphHashed', any>;
}
...
function createContext<UN>(options?: {
  ...
  return new ValuedGraphContext<UN, 'ArrowValuedGraphHashed', TypesImpl>(
    true,
