...
import { ArrowValuedGraphBase, ValuedGraphContext } from '../../graph-custom';
...
export namespace ArrowValuedGraphSorted {
  ...
  export interface Types extends ArrowValuedGraphBase.Types {
    normal: ArrowValuedGraphSorted<this['_N'], this['_V']>;
    nonEmpty: ArrowValuedGraphSorted.NonEmpty<this['_N'], this['_V']>;
    context: ArrowValuedGraphSorted.Context<this['_N']>;
    builder: ArrowValuedGraphSorted.Builder<this['_N'], this['_V']>;
...
interface TypesImpl extends ArrowValuedGraphSorted.Types {
  context: ValuedGraphContext<this['_N'], 'ArrowValuedGraphSorted', any>;
}
...
function createContext<UN>(options?: {
  ...
  return new ValuedGraphContext<UN, 'ArrowValuedGraphSorted', TypesImpl>(
    true,
