...
interface TypesImpl extends EdgeValuedGraphHashed.Types {
  context: ValuedGraphContext<this['_N'], 'EdgeValuedGraphHashed', any>;
}
...
function createContext<UN>(options?: {
  ...
  return new ValuedGraphContext<UN, 'EdgeValuedGraphHashed', TypesImpl>(
    false,
