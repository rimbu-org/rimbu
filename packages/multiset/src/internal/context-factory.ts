...
export interface ContextImpl<UT>
	extends MultiSet.Advanced.ContextApi<UT, MultiSet.Advanced.Family<UT>> {
...
export abstract class MultiSetContextBase<
		UT,
		FAM extends MultiSet.Advanced.Family<UT>,
	>
	extends ContextBaseWithAddAll<FAM>
	implements MultiSet.Advanced.ContextApi<UT, FAM>
{
	abstract readonly countMapContext: MapCollection.Context<
	...
	createBuilder<T extends UT>(
		...
		return new MultiSetBuilder<T>(this as any, source as any) as any;
	}
...
export class MultiSetContext<UT> extends MultiSetContextBase<
	UT,
...
export class HashMultiSetContext<UE> extends MultiSetContextBase<
	UE,
...
export class SortedMultiSetContext<UE> extends MultiSetContextBase<
	UE,
