...
> extends FastIterable<[K, V]> {
   ...
   */
  readonly keyMap: CB.WithKeyValue<Tp, K, V>['keyMap'];
  /**
  ...
  getValues<UK = K>(
    key: RelatedTo<K, UK>
  ): CB.WithKeyValue<Tp, K, V>['keyMapValues'];
  /**
  ...
  removeKeyAndGet<UK = K>(
    ...
    | [
        CB.WithKeyValue<Tp, K, V>['normal'],
        CB.WithKeyValue<Tp, K, V>['keyMapValuesNonEmpty']
      ]
    | undefined;
  /**
...
export namespace VariantMultiMapBase {
  ...
  > extends VariantMultiMapBase<K, V, Tp>,
     ...
     */
    readonly keyMap: CB.WithKeyValue<Tp, K, V>['keyMapNonEmpty'];
    /**
...
> extends VariantMultiMapBase<K, V, Tp> {
  ...
  modifyAt(
    ...
    options: {
      ...
      ifExists?: (
        currentValues: CB.WithKeyValue<Tp, K, V>['keyMapValuesNonEmpty']
      ) => StreamSource<V>;
    }
  ): CB.WithKeyValue<Tp, K, V>['normal'];
  /**
...
export namespace MultiMapBase {
  ...
  > {
     ...
     */
    readonly keyMapContext: CB.WithKeyValue<Tp, UK, UV>['keyMapContext'];
    readonly keyMapValuesContext: CB.WithKeyValue<
      Tp,
      UK,
      UV
    >['keyMapValuesContext'];
