...
| Name                                                                  | Description                                     |
| --------------------------------------------------------------------- | ----------------------------------------------- |
| [`VariantMultiSet<T>`](/api/rimbu/multiset/VariantMultiSet/namespace) | a type-variant MultiSet with elements of type T |
| [`MultiSet<T>`](/api/rimbu/multiset/MultiSet/namespace)               | a generic MultiSet with elements of type T      |

The `@rimbu/core` package exports the following _concrete_ Multiset types:

| Name                                                                | Description                               |
| ------------------------------------------------------------------- | ----------------------------------------- |
| [`HashMultiSet<T>`](/api/rimbu/multiset/HashMultiSet/namespace)     | a MultiSet with hashed elements of type T |
| [`SortedMultiSet<T>`](/api/rimbu/multiset/SortedMultiSet/namespace) | a MultiSet with sorted elements of type T |
