...
:::info
The Rimbu List TypeScript implementation is a novel data structure invented by the author of this library. See [List advaned topics](/docs/advanced/list) for more information.
:::

## Exports

The `@rimbu/core` package exports the following _concrete_ List types:

| Name                                        | Description                                                |
| ------------------------------------------- | ---------------------------------------------------------- |
| [`List<T>`](/api/rimbu/list/List/namespace) | A random accessible immutable sequence of values of type T |
