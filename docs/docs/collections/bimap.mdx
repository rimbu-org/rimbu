...
The `@rimbu/core` package exports the following _concrete_ BiMap TypeScript types:

| Name                                              | Description                                                   |
| ------------------------------------------------- | ------------------------------------------------------------- |
| [`BiMap<K, V>`](/api/rimbu/bimap/BiMap/namespace) | a generic `BiMap` between keys of type K and values of type V |
