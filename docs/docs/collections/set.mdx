...
| Name                                                                    | Description                        |
| ----------------------------------------------------------------------- | ---------------------------------- |
| [`VariantSet<T>`](/api/rimbu/collection-types/set/VariantSet/namespace) | a type-variant set of value type T |
| [`RSet<T>`](/api/rimbu/collection-types/set/RSet/namespace)             | a generic set of value type T      |

The `@rimbu/core` package exports the following _concrete_ Set TypeScript types:

| Name                                                           | Description                                                  |
| -------------------------------------------------------------- | ------------------------------------------------------------ |
| [`HashSet<T>`](/api/rimbu/hashed/set/HashSet/namespace)        | a set of value type T where items are hashed with a `Hasher` |
| [`SortedSet<T>`](/api/rimbu/sorted/set/SortedSet/namespace)    | a set of value type T where items are sorted with a `Comp`   |
| [`OrderedSet<T>`](/api/rimbu/ordered/set/OrderedSet/namespace) | a set of value type T where insertion order is maintained    |
