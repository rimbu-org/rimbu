...
| [`SortedSet<T>`](/api/rimbu/sorted/SortedSet/namespace)    | a set of value type T where items are sorted with a `Comp`   |
| [`OrderedSet<T>`](/api/rimbu/ordered/OrderedMap/namespace) | a set of value type T where insertion order is maintained    |
